...
- **번들 크기** 를 신경 쓰는 앱 — 피커 7종 전부가 경쟁 라이브러리 하나치 정도 공간에 들어가고 CI 로 천장을 강제하며, 쓰지 않는 picker 는 제거됩니다(TimePicker 하나 약 16.2 KB, 7종 전부 약 25.0 KB). [트러블슈팅 → 번들 크기](./troubleshooting.md#번들-크기가-예상보다-큽니다) 참고.
