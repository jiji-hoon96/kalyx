---
name: testing-ci
description: 'CI 환경에서의 테스트 자동화. 커버리지 게이팅, 병렬 테스트, E2E 테스트 (Playwright), 시각적 회귀 테스트까지. 다음 상황에서 사용한다: "CI 테스트를 설정할 때", "E2E 테스트를 추가할 때", "커버리지가 낮을 때", "테스트가 느릴 때", "Playwright 테스트를 작성할 때"'
---
